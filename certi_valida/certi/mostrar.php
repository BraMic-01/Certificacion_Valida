    ...
    <div class="tabla" style="margin-left: 300px; margin-top: 50px; text-align: center;">
        ...
        $resultado = mysqli_query($conexion, $mostrar)
          ...
          echo '<table border="1">';
            ...
            echo '<th id="tipoc">Tipo de Certificado</th>';
            ...
            while ($row = $resultado->fetch_array()) {
              echo '<tr>';
              echo '<td>'.$row['cer_nombre'];
              echo '<td>'.$row['cer_folio'];
              echo '<td>'.$row['cer_tipo'];
              echo '<td>'.$row['cer_fecha_certificacion'];
              echo '<td>'.$row['cer_vigencia'];
            }
